...
namespace GalerieDeArta
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void pictureBox1_MouseClick(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                x++;
                name.Add(x);
                points.Add(new Punct(new PointF(e.X,e.Y)));
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            label1.Text = "Culoarea optima " + colorsName[minIndex] + " cu " + colorsCount[minIndex] + " (de) aparitii";
        }
    ...
    public class Punct
    {
        ...
        {
            this.pozitie.X = pos.X;
            this.pozitie.Y = pos.Y;
            this.culoare = -1;
            this.vecini = new List<Punct>();
        }
    }
}
